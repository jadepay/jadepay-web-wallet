...
(function () {
	...
	/* public vars */
	coinjs.pub = 0x2b; // PUBKEY_ADDRESS
	coinjs.priv = 0x80; // SECRET_KEY
	coinjs.multisig = 0x5; // SCRIPT_ADDRESS
	coinjs.hdkey = {'prv':0x0488ade4, 'pub':0x0488b21e};

	coinjs.compressed = false;

	/* other vars */
	coinjs.developer = 'JbujKSjAsPhFUEq4vz4RKd4Mb43EQW5Awu'; // jadepay
	...
	*/
	...
	coinjs.hd = function(data){
		...
		r.master = function(pass) {
			...
			var I = hasher.getHMAC("jadepay seed", "TEXT", "SHA-512", "HEX");
